Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "README.rdoc", "Manifest.txt", "Rakefile", "lib/yahoo_stock.rb", "lib/yahoo_stock/quote.rb", "lib/yahoo_stock/interface.rb", "lib/yahoo_stock/scrip_symbol.rb","lib/yahoo_stock/history.rb", "spec/spec_helper.rb", "spec/yahoo_stock/quote_spec.rb", "spec/yahoo_stock/interface_spec.rb", "spec/yahoo_stock/scrip_symbol_spec.rb", "spec/yahoo_stock/history_spec.rb"]
  s.has_rdoc = true
